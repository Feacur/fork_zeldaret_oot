...
EntranceCutscene sEntranceCutsceneTable[] = {
    ...
    { ENTR_TEMPLE_OF_TIME_0, 2, EVENTCHKINF_WARP_IN_TEMPLE_OF_TIME, gTempleOfTimeIntroCs },
    ...
    { ENTR_LAKE_HYLIA_0, 2, EVENTCHKINF_WARP_IN_LAKE_HYLIA, gLakeHyliaIntroCs },
    ...
    { ENTR_GRAVEYARD_0, 2, EVENTCHKINF_WARP_IN_GRAVEYARD, gGraveyardIntroCs },
    { ENTR_ZORAS_FOUNTAIN_2, 2, EVENTCHKINF_B7, gZorasFountainIntroCs },
    { ENTR_DESERT_COLOSSUS_0, 2, EVENTCHKINF_WARP_IN_DESERT_COLOSSUS, gDesertColossusIntroCs },
    { ENTR_DEATH_MOUNTAIN_CRATER_0, 2, EVENTCHKINF_WARP_IN_DEATH_MOUNTAIN_CRATER, gDeathMountainCraterIntroCs },
    ...
    if ((csCtx->curFrame == cmd->startFrame) || titleDemoSkipped ||
        ...
        switch (cmd->destination) {
            ...
            case CS_DEST_TEMPLE_OF_TIME_FROM_MASTER_SWORD:
                ...
                if (!GET_EVENTCHKINF(EVENTCHKINF_HAS_MASTER_SWORD)) {
                    SET_EVENTCHKINF(EVENTCHKINF_HAS_MASTER_SWORD);
                    play->nextEntranceIndex = ENTR_CUTSCENE_MAP_0;
                    play->transitionTrigger = TRANS_TRIGGER_START;
