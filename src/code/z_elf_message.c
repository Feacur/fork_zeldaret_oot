...
QuestHintCmd sChildSariaQuestHints[] = {
    ...
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_ZORA_SAPPHIRE, false, 0x61),
    QUEST_HINT_END(0x64),

    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_GORON_RUBY, false, 0x62),
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_ZORA_SAPPHIRE, false, 0x63),
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_OCARINA_OF_TIME, false, 0x65),
