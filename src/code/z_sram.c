...
void Sram_OpenSave(SramContext* sramCtx) {
    ...
    if (GET_EVENTCHKINF(EVENTCHKINF_HAS_ZELDAS_LETTER) && !CHECK_QUEST_ITEM(QUEST_SONG_LULLABY)) {
        i = gSaveContext.save.info.eventChkInf[EVENTCHKINF_HAS_ZELDAS_LETTER_INDEX] & ~EVENTCHKINF_HAS_ZELDAS_LETTER_MASK;
        gSaveContext.save.info.eventChkInf[EVENTCHKINF_HAS_ZELDAS_LETTER_INDEX] = i;
