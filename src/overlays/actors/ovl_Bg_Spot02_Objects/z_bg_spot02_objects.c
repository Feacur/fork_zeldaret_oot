...
void BgSpot02Objects_Init(Actor* thisx, PlayState* play) {
    ...
    switch (thisx->params) {
        ...
        case 2:
            ...
            if ((GET_EVENTCHKINF(EVENTCHKINF_UNKNOWN_GRAVEYARD_BOMB_EFFECT_0x1D) && (play->sceneId == SCENE_GRAVEYARD) && (thisx->params == 2)) ||
        ...
        case 3:
            ...
            if (GET_EVENTCHKINF(EVENTCHKINF_UNKNOWN_GRAVEYARD_BOMB_EFFECT_0x1D)) {
                Actor_Kill(thisx);
            }
            break;
...
void func_808AC908(BgSpot02Objects* this, PlayState* play) {
    ...
    if (play->csCtx.state != CS_STATE_IDLE) {
        if (play->csCtx.actorCues[3] != NULL && play->csCtx.actorCues[3]->id == 2) {
            ...
            SET_EVENTCHKINF(EVENTCHKINF_UNKNOWN_GRAVEYARD_BOMB_EFFECT_0x1D);
            this->timer = 25;
