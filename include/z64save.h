...
#define EVENTCHKINF_0X_INDEX 0x0
#define EVENTCHKINF_TALKED_TO_MIDO_WITHOUT_EQUIPMENT 0x02 // "Hey you! Mr. no Fairy!"
#define EVENTCHKINF_TALKED_TO_SARIA_AFTER_MIDO 0x03 // "What?! Mido won't let you ...?"
#define EVENTCHKINF_TALKED_TO_MIDO_IN_KOKIRI_FOREST 0x04 // "If you want to pass ..."
#define EVENTCHKINF_UNKNOWN_DEKU_0x05 0x05
#define EVENTCHKINF_HAS_KOKIRI_EMERALD_ONCE 0x07
#define EVENTCHKINF_HAS_KOKIRI_EMERALD 0x09
#define EVENTCHKINF_TALKED_TO_MIDO_IN_LOST_WOODS 0x0A // "That melody?!"
#define EVENTCHKINF_MIDO_MEETS_ADULT_LINK 0x0B // will say "When I see you..."
#define EVENTCHKINF_DEKU_0x0C 0x0C
#define EVENTCHKINF_MIDO_TELLS_SARIA_IN_LOST_WOODS 0x0F // "If you're looking for Saria ..."
#define EVENTCHKINF_TALKED_TO_MALON_FIRST_TIME 0x10
#define EVENTCHKINF_INGO_YOU_LITTLE_WEIRDO 0x11 // "You little weirdo!"
...
#define EVENTCHKINF_INGO_0x1B 0x1B
#define EVENTCHKINF_MIDO_IN_KOKIRI_FOREST_0x1C 0x1C
#define EVENTCHKINF_UNKNOWN_GRAVEYARD_BOMB_EFFECT_0x1D 0x1D
#define EVENTCHKINF_HORSE_RACE_COW_UNLOCK 0x1E
#define EVENTCHKINF_GORON_SAID_ASK_BIG_BROTHER 0x20 // "Ask Big Brother ..."
#define EVENTCHKINF_GORON_0x21 0x21
#define EVENTCHKINF_DARUNIA_HEARD_NOT_SARIA_SONG 0x22 // "I wanted to hear...a tune..."
#define EVENTCHKINF_DC_BOULDER_DESTROYED 0x23 // as per comment @ `z_en_go2.c`
#define EVENTCHKINF_HAS_GORON_RUBY 0x25
#define EVENTCHKINF_UNKNOWN_SHEIK_2A 0x2A // will say "Did Ruto want to thank me?"
#define EVENTCHKINF_UNKNOWN_SHEIK_2B 0x2B // will say "Did Ruto want to thank me?"
#define EVENTCHKINF_UNKNOWN_SHEIK_2C 0x2C // will say "Did Ruto want to thank me?"
#define EVENTCHKINF_UNKNOWN_SHEIK_2D 0x2D // will say "Did Ruto want to thank me?"
#define EVENTCHKINF_UNKNOWN_LAVA_ERUPT_2F 0x2F
#define EVENTCHKINF_TALKED_TO_ZORAS 0x30 // "We are the Zoras ..."
#define EVENTCHKINF_UNKNOWN_COLLECTED_ITEM_0x31 0x31
#define EVENTCHKINF_TALKED_TO_ZORA_NEAR_SHORE 0x32 // "We Zoras all serve the great King Zora"
#define EVENTCHKINF_OPENED_BOTTLE_RUTOS_LETTER 0x33
#define EVENTCHKINF_HAS_ZORA_SAPPHIRE 0x37
#define EVENTCHKINF_UNKNOWN_DIVING_MINIGAME_0x38 0x38
#define EVENTCHKINF_OPENED_ZORA_DOMAIN 0x39
#define EVENTCHKINF_JABUJABU_FISH_GIVEN 0x3A
#define EVENTCHKINF_IRON_KNUCKLE_HOSTILE 0x3B
#define EVENTCHKINF_IRON_KNUCKLE_DEFEATED 0x3C

// 0x40
#define EVENTCHKINF_HAS_ZELDAS_LETTER_INDEX 0x4
#define EVENTCHKINF_HAS_ZELDAS_LETTER_SHIFT 0x0
#define EVENTCHKINF_HAS_ZELDAS_LETTER_MASK (1 << EVENTCHKINF_HAS_ZELDAS_LETTER_SHIFT)
#define EVENTCHKINF_HAS_ZELDAS_LETTER ((EVENTCHKINF_HAS_ZELDAS_LETTER_INDEX << 4) | EVENTCHKINF_HAS_ZELDAS_LETTER_SHIFT)

#define EVENTCHKINF_SHOWN_ZELDAS_LETTER 0x41
#define EVENTCHKINF_EPONA_RACE_FINISH 0x42
#define EVENTCHKINF_HAS_OCARINA_OF_TIME 0x43
#define EVENTCHKINF_HAS_MASTER_SWORD 0x45
...
// 0x6B
#define EVENTCHKINF_TALON_RETURNED_FROM_KAKARIKO_INDEX 0x6
#define EVENTCHKINF_TALON_RETURNED_FROM_KAKARIKO_SHIFT 0xB
...
#define EVENTCHKINF_CARPENTERS_FREE_INDEX 0x9
...
#define EVENTCHKINF_WARP_IN_TEMPLE_OF_TIME 0xA7
#define EVENTCHKINF_A8 0xA8
#define EVENTCHKINF_A9 0xA9
#define EVENTCHKINF_VISITED_KAKARIKO_VILLAGE 0xAA
#define EVENTCHKINF_VISITED_DESERT_COLOSSUS 0xAC
#define EVENTCHKINF_DISPELED_SPIRIT_BARRIER 0xAD
#define EVENTCHKINF_B0 0xB0
#define EVENTCHKINF_WARP_IN_LAKE_HYLIA 0xB1
#define EVENTCHKINF_B2 0xB2
#define EVENTCHKINF_B3 0xB3
#define EVENTCHKINF_B4 0xB4
#define EVENTCHKINF_B5 0xB5
#define EVENTCHKINF_WARP_IN_GRAVEYARD 0xB6
#define EVENTCHKINF_B7 0xB7
#define EVENTCHKINF_WARP_IN_DESERT_COLOSSUS 0xB8
#define EVENTCHKINF_WARP_IN_DEATH_MOUNTAIN_CRATER 0xB9
#define EVENTCHKINF_BA 0xBA
#define EVENTCHKINF_DISPELED_FOREST_BARRIER 0xBB
#define EVENTCHKINF_DISPELED_WATER_BARRIER 0xBC
#define EVENTCHKINF_DISPELED_SHADOW_BARRIER 0xBD
#define EVENTCHKINF_DISPELED_FIRE_BARRIER 0xBE
#define EVENTCHKINF_DISPELED_LIGHT_BARRIER 0xBF
#define EVENTCHKINF_C0 0xC0
#define EVENTCHKINF_VISITED_LOST_WOODS 0xC1
#define EVENTCHKINF_DISPELED_TOWER_BARRIER 0xC3
#define EVENTCHKINF_VISITED_TEMPLE_OF_TIME 0xC4
#define EVENTCHKINF_C5 0xC5
#define EVENTCHKINF_C6 0xC6
#define EVENTCHKINF_VISITED_GANON_BOSS 0xC7
#define EVENTCHKINF_C8 0xC8
#define EVENTCHKINF_C9 0xC9

// 0xD0-0xD6
#define EVENTCHKINF_SONGS_FOR_FROGS_INDEX 0xD
#define EVENTCHKINF_SONGS_FOR_FROGS_CHOIR_SHIFT  0x0
#define EVENTCHKINF_SONGS_FOR_FROGS_ZL_SHIFT     0x1
#define EVENTCHKINF_SONGS_FOR_FROGS_EPONA_SHIFT  0x2
#define EVENTCHKINF_SONGS_FOR_FROGS_SUNS_SHIFT   0x3
#define EVENTCHKINF_SONGS_FOR_FROGS_SARIA_SHIFT  0x4
#define EVENTCHKINF_SONGS_FOR_FROGS_SOT_SHIFT    0x5
#define EVENTCHKINF_SONGS_FOR_FROGS_STORMS_SHIFT 0x6
...
// 0xDA-0xDE
#define EVENTCHKINF_DX_INDEX 0xD
...
// 0x18-0x1A
#define ITEMGETINF_1X_INDEX 0x1
#define ITEMGETINF_18_SHIFT 0x8
#define ITEMGETINF_19_SHIFT 0x9
#define ITEMGETINF_1A_SHIFT 0xA
...
#define ITEMGETINF_18 ((ITEMGETINF_1X_INDEX << 4) | ITEMGETINF_18_SHIFT)
#define ITEMGETINF_19 ((ITEMGETINF_1X_INDEX << 4) | ITEMGETINF_19_SHIFT)
#define ITEMGETINF_1A ((ITEMGETINF_1X_INDEX << 4) | ITEMGETINF_1A_SHIFT)
...
#define INFTABLE_TALKED_TO_KAKARIKO_GUARD 0x76
...
// 0x199-0x19F
#define INFTABLE_19X_INDEX 0x19
...
// 0x1A0-0x1AF
#define INFTABLE_1AX_INDEX 0x1A
#define INFTABLE_1A0_SHIFT 0x0
#define INFTABLE_1A1_SHIFT 0x1
#define INFTABLE_1A2_SHIFT 0x2
#define INFTABLE_1A3_SHIFT 0x3
#define INFTABLE_1A4_SHIFT 0x4
#define INFTABLE_1A5_SHIFT 0x5
#define INFTABLE_1A6_SHIFT 0x6
#define INFTABLE_1A7_SHIFT 0x7
#define INFTABLE_1A8_SHIFT 0x8
#define INFTABLE_1A9_SHIFT 0x9
#define INFTABLE_1AB_SHIFT 0xB
#define INFTABLE_1AD_SHIFT 0xD

// 0x1D0-0x1DF
#define INFTABLE_EQUIPMENT_INDEX 0x1D // as per `Inventory_DeleteEquipment` @ `code_80097A00.c`
...
// 0x00-0x0F
// horses related
#define EVENTINF_HORSES_INDEX 0x0
#define EVENTINF_HORSES_STATE_SHIFT 0x0
#define EVENTINF_HORSES_HORSETYPE_SHIFT 0x4
#define EVENTINF_HORSES_05_SHIFT 0x5
#define EVENTINF_HORSES_06_SHIFT 0x6
#define EVENTINF_HORSES_08_SHIFT 0x8
#define EVENTINF_HORSES_0A_SHIFT 0xA
#define EVENTINF_HORSES_0F_SHIFT 0xF // unused?
...
// 0x20-0x24
#define EVENTINF_2X_INDEX 0x2
#define EVENTINF_20_MASK (1 << 0x0)
#define EVENTINF_21_MASK (1 << 0x1)
#define EVENTINF_22_MASK (1 << 0x2)
#define EVENTINF_23_MASK (1 << 0x3)
#define EVENTINF_24_MASK (1 << 0x4)
