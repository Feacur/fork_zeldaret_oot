...
QuestHintCmd gOverworldNaviQuestHints[] = {
    ...
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_ZELDAS_LETTER, false, 0x44),
    ...
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_OCARINA_OF_TIME, false, 0x4C),
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_HAS_MASTER_SWORD, false, 0x4D),
    ...
    QUEST_HINT_FLAG(CHECK, EVENTCHKINF_VISITED_KAKARIKO_VILLAGE, false, 0x54),
